...
* [Extensions](products/extensions/README.md)
  ...
  * [B2B Components](products/extensions/b2b-components/README.md)
    * [Guides](products/extensions/b2b-components/guides/README.md)
      * [Create permissions via app](products/extensions/b2b-components/guides/creating-own-permissions-via-app.md)
      * [Create permissions via plugin](products/extensions/b2b-components/guides/creating-own-permissions-via-plugin.md)
